		...
		<ul className={`flex items-center justify-center gap-4 sm:gap-8 xl:flex-row xl:gap-10 ${className}`}>
			{xLink && (
				<li className="">
					<a target="_blank" href={xLink}>
						<Image
							className="h-[42px] w-[auto] transition-all duration-200 ease-in-out hover:rotate-12 lg:h-[60px]"
							src="/xlogo.svg"
							height={0}
							width={0}
							alt="twitter logo"
			...
			{pumpLink && (
				<li className="flex h-[42px] w-[42px] cursor-pointer items-center justify-center rounded-full bg-black lg:h-[60px] lg:w-[60px]">
					...
					>
						<Image
							className="h-auto w-[20px] transition-all duration-200 ease-in-out hover:rotate-12 lg:w-[40px]"
							src="/logo.webp"
							height={0}
							width={100}
							alt="twitter logo"
			...
			{DexsLink && (
				<li className="flex h-[42px] w-[42px] cursor-pointer items-center justify-center rounded-full bg-black lg:h-[60px] lg:w-[60px]">
					<a
						target="_blank"
						className="flex h-full w-full items-center justify-center rounded-full transition-all duration-200 ease-in-out hover:rotate-12"
						href={DexsLink}
					>
						<svg
			...
			{DextLink && (
				<li className="">
					<a target="_blank" href={DextLink}>
						<Image
							className="rotate h-[42px] w-auto transition-all duration-200 ease-in-out hover:rotate-12 lg:h-[60px]"
